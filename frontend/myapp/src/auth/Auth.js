  ...
  return(
    ...
    <form onSubmit={handleSubmit}>
      ...
      >
        ...
        value={input.name} name="name" required margin="normal"/>
        </>
        )}
        ...
        <TextField
          ...
          type="password"
          margin="normal"/>
        <Button sx={{marginTop: 2, borderRadius:10}}type="submit" variant="contained">
          {isSignup ? "Signup" : "Login"}
          </Button>
        <Button onClick={()=> setIsSignup(!isSignup)} sx={{marginTop: 2, borderRadius:10}} variant="outlined">
